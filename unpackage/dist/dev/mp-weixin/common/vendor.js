...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"党员“码”上查","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* WEBPACK VAR INJECTION */(function(uni) {var methodToPatch = ['navigateTo', 'redirectTo', 'switchTab', 'navigateBack'];
